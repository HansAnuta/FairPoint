<?php
/**
 * Partial Content for Simple Averaging Judging Method
 * This file is included by admin/manage_competition.php
 * Displays Participants and Criteria tabs for simple averaging.
 */

if (!isset($competition_id)) {
    echo '<p class="error-message">Error: Competition ID not provided for Simple Averaging management.</p>';
    return;
}
...
if ($stmt_part) {
    ...
    error_log("Failed to prepare statement for fetching participants (Simple Averaging): " . $conn->error);
}
...
<div class="competition-tabs">
    ...
    <div id="participants-tab" class="tab-content <?php echo ($active_subtab === 'participants') ? 'active' : ''; ?>">
        <div class="section-header">
            <h2 class="tab-heading">Participants for Simple Averaging</h2>
    ...
    <div id="criteria-tab" class="tab-content <?php echo ($active_subtab === 'criteria') ? 'active' : ''; ?>">
        <div class="section-header">
            <h2 class="tab-heading">Criteria for Simple Averaging</h2>
        ...
        <div class="list-container">
            <?php if (empty($criteria)): ?>
                <p>No criteria found for this competition. For Simple Averaging, criteria typically have equal importance (or defined by their numerical range).</p>
            <?php else: ?>
